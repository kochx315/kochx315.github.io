...
@Component({
  selector: 'app-external-dynamsoft',
  templateUrl: './external-dynamsoft.component.html',
  styleUrls: ['./external-dynamsoft.component.css']
})
export class ExternalDynamsoftComponent implements OnInit {
  id: string;
  result = '';
  video: any;
  scanner: any;
