...
@Component({
  selector: 'app-webcam-zxing-current',
  templateUrl: './webcam-zxing-current.component.html',
  styleUrls: ['./webcam-zxing-current.component.css']
})
export class WebcamZxingCurrentComponent implements OnInit {
  id: string;
  result = '';
  video: any;
  codeReader: any;
